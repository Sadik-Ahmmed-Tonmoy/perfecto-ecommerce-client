            ...
            <Drawer
                title={
                    <span className="text-black font-inter text-[24px] font-semibold leading-normal">
                        My Bag <span className="text-[#000000A6] font-inter text-base font-normal leading-normal">(3 Items)</span>
                    </span>
                }
                placement={"right"}
                width={500}
                ...
                <div>
                    {hasCartItem ? (
                        ...
                        <div className="flex flex-col justify-between h-[calc(100vh-195px)] overflow-y-auto slim-scroll p-3">
                            <div>
                                <CartCard className={"mb-3"} />
                                <CartCard className={"mb-3"} />

                                <div onClick={() => setApplyCouponOpen(true)} className="border-[0.5px] bg-white rounded flex items-center justify-between w-full mb-3 p-3 hover:cursor-pointer">
                                ...
                                <div  onClick={() => setApplyRewardPointOpen(true)}  className="border-[0.5px] bg-white rounded flex items-center justify-between w-full mb-3 p-3 hover:cursor-pointer">
                                    <div className="flex items-center  gap-3">
                                    ...
                                    <p className="text-black text-right font-inter text-sm font-semibold leading-normal whitespace-nowrap">-৳ 550</p>
                                </div>
                            ...
                            >
                                <div className="flex justify-between items-center">
                                    <div>
                                        ...
                                        <h4 className="text-black font-inter text-[20px] xs:text-[26px] font-bold leading-normal">৳550</h4>
                                    </div>
                                    <MainButton
                                        title={"Proceed"}
