                ...
                <div className="pt-2 px-2 pb-2 xs:px-5 md:pt-3 md:px-7 md:pb-5 lg:pt-6 lg:px-[60px] lg:pb-[40px]">
                                    ...
                                    <div className="relative flex items-center">
                                        <input
                                            ...
                                            className={`rounded h-4 w-4 ${
                                                selectedCheckbox == true ? "bg-[#5DC9F4] text-white" : "bg-white"
                    ...
                    <div className="flex flex-col gap-2 lg:gap-3">
                        ...
                        <Link to={"/login-with-phone"}>
                            {" "}
                            <p className="text-center  text-black text-sm font-medium leading-normal tracking-[-0.12px]">Login With OTP</p>
                        </Link>
                        <p className="text-center  text-black text-opacity-60 text-xs font-normal leading-normal tracking-[-0.12px]">or</p>
                       <SocialLogin/>
                    </div>
