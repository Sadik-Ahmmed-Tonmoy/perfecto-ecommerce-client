...
const SocialLogin = () => {
    ...
    return (
        <div className="w-20 flex justify-between items-center mx-auto">
            <FaFacebook onClick={handleFacebookSignIn} size={24} className="text-[#0A8DDD] hover:cursor-pointer" />{" "}
            <FcGoogle className="hover:cursor-pointer" onClick={handleGoogleSignIn} size={26} />
        </div>
    );
};
