...
const AllReviewPage = () => {
    ...
    return (
        <div className='container mx-auto px-[10px]'>
               ...
               <p className='text-black font-Inter text-base md:text-[20px] font-medium mb-3'>Lakme Absolute Skin Dew Color Sensational Ultimattes Satin Lipstick - 102 Nude Rose - All Reviews</p>
              {/* rating start */}
...
<p className='text-[#000000A6] font-Inter text-sm font-medium'>Perfecto is committed to showing genuine and verified reviews.</p>
                            ...
                            <div className="py-2 md:p-5">
                                ...
                                <div className="border-t-[1px] border-b-[1px] py-5">
                                    <p className={`text-[#000000A6] text-sm font-semibold leading-5  pb-[15px] text-black mb-1`}>
                                    Refine Reviews By
                                    </p>
                                    <div className='flex flex-wrap items-center gap-3'>
                                       
                                        <Button className="font-medium text-xs rounded-full pt-2" variant="bordered">Verified Buyers</Button>
                                        <Button className="font-medium text-xs rounded-full pt-2 border-[#CECECE] text-[#000000BF]" variant="bordered">With Images</Button>
                                        <Button className="font-medium text-xs rounded-full pt-2 border-[#CECECE] text-[#000000BF]" variant="bordered">5 Star</Button>
                                        <Button className="font-medium text-xs rounded-full pt-2 border-[#CECECE] text-[#000000BF]" variant="bordered">4 Star</Button>
                                        <Button className="font-medium text-xs rounded-full pt-2 border-[#CECECE] text-[#000000BF]" variant="bordered">3 Star</Button>
                                        <Button className="font-medium text-xs rounded-full pt-2 border-[#CECECE] text-[#000000BF]" variant="bordered">2 Star</Button>
                                        <Button className="font-medium text-xs rounded-full pt-2 border-[#CECECE] text-[#000000BF]" variant="bordered">1 Star</Button>
                                    </div>
                                </div>
                                <div className="">
                                    {/* <p className={`text-[#000000A6] text-sm font-semibold leading-5 pt-3  md:pt-[15px] text-black mb-1`}>
                                        Most Useful Review
                                    </p> */}
                                                    ...
                                                    <div className="w-full">
                                                       ...
                                                       <div onClick={showModal}>
                                                                ...
                                                                <p className="text-[#000000A6] text-sm font-normal leading-normal mb-4">
                                                                    It feels light and weightless and has a matte finish that looks fabulous on the
                                                                    pout. This one feels non-sticky and repairs flakiness as is infused with Avocado
                                                                    oil and hyalu...
            ...
            >
                <div className="w-full relative">
                    <div onClick={handleCancel} className="absolute top-2 left-2 md:top-7 md:left-7 z-10 bg-[#00000080] rounded-full p-1 md:p-2 hover:cursor-pointer">
