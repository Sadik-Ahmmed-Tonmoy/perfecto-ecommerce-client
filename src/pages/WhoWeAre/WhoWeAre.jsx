...
const WhoWeAre = () => {
  return (
    <div className="mb-10 md:mb-20">
      ...
      <div
        className={twMerge(
          ` bg-cover bg-center object-cover bg-no-repeat w-full `
        )}
        style={{
        ...
        <div className="container mx-auto px-[10px] ">
          <div className="flex flex-col md:flex-row items-center md:gap-9 mb-5">
            ...
            <div className="md:w-1/2">
              <h5 className="text-2xl font-bold">
                Products of world famous brand
              </h5>
              <p className="text-base font-medium text-[#000000BF] md:w-6/12">
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:gap-9">
            ...
            <div className="md:w-4/12">
              <h5 className="text-2xl font-bold">
                Widest range of beauty products{" "}
              </h5>
              <p className="text-base font-medium text-[#000000BF]">
                We stock one of the widest range of beauty products available
                and are constantly sourcing and evaluating new products from all
                over the world.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-[10px] grid grid-cols-1 md:grid-cols-2 p-16">
          ...
          <div className="relative">
            ...
            <div className="absolute top-0  h-full w-full flex justify-center items-center p-5 lg:p-16">
              <div>
                <div className=" flex justify-center">
                  <h5 className="pb-2 border-b-2 border-white text-white text-center font-Inter text-base md:text-2xl lg:text-[48px] font-bold leading-normal w-fit mb-3 lg:mb-8">
                    Our Mission
                  </h5>
                </div>
                <p className="text-white text-center font-Inter text-xs md:text-base font-medium md:leading-6">
                  Our group of experts and trainees is dedicated to excellence
                  across the board for our company. This covers the caliber of
                  the tools, the instruction, and the team's constant follow-up
                  and customer care! We collaborate closely with the companies
                  we serve to provide dependent-on-experience recommendations,
                  upskill staff members, and generally improve their own
                  businesses.
                </p>
              </div>
            </div>
