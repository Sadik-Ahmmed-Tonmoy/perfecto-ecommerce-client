    ...
    return (
        <>
            <div style={{ boxShadow: "0px 0px 8px 0px rgba(228, 237, 240, 0.65)" }} className="rounded-lg bg-white">
                ...
                <div className="flex flex-col gap-3 md:gap-5 pt-3 pb-3 px-1 xs:px-3 md:mb-3 md:pt-5 lg:pt-6 md:px-6 lg:px-8">
                    {/* per order start  */}
                    <>
                            ...
                            <div className="flex items-center gap-4 w-full">
                                ...
                                <div className="w-full">
                                    <div className="flex flex-wrap gap-x-2 justify-between ">
                                        ...
                                        <p className="text-[#000000CC] font-inter text-xs md:text-sm font-normal leading-normal whitespace-nowrap">
                                            24 Nov 2023
                                        </p>
                                    </div>
                        ...
                        <div className="flex justify-between border hover:cursor-pointer border-[#E2E8F0] rounded-lg bg-[#FFF] px-5 py-4">
                            <div className="flex items-center gap-4 w-full">
                                ...
                                <div className="w-full">
                                    ...
                                    <p className="text-[#000000CC] font-inter text-xs md:text-sm font-medium leading-normal">
                                    Order <span className="text-black font-inter text-xs md:text-sm  font-semibold leading-normal">#875355 - EU</span> has been completed & arrived at the destinaton address.                                    </p>
                                </div>
                            </div>
                        </div>
                    </>
